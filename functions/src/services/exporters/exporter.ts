...
export class XlsxExporter {
  createChildList(list: ReadonlyArray<IChild>): ExcelData {
    return {
      worksheets: [
        {
          name: 'Alle kinderen',
  ...
  createCrewList(list: ReadonlyArray<ICrew>): ExcelData {
    return {
      worksheets: [
        {
  ...
  createChildrenWithCommentList(list: ReadonlyArray<IChild>): ExcelData {
    return {
      worksheets: [
        {
  ...
  buildExcelFile(data: ExcelData): LocalFileCreationResult {
